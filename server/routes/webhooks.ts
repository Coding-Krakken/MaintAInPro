...
export function registerWebhookRoutes(
  ...
  app.get('/api/webhooks', authenticateRequest, async (req, res) => {
    try {
      ...
      console.__error('List webhooks _error:', _error);
  ...
  app.get('/api/webhooks/:id', authenticateRequest, async (req, res) => {
    try {
      ...
      console.__error('Get webhook _error:', _error);
  ...
  app.post(
    ...
    async (req, res) => {
      try {
        ...
        console.__error('Create webhook _error:', _error);
  ...
  app.put(
    ...
    async (req, res) => {
      try {
        ...
        console.__error('Update webhook _error:', _error);
  ...
  app.delete(
    ...
    async (req, res) => {
      try {
        ...
        console.__error('Delete webhook _error:', _error);
  ...
  app.get('/api/webhooks/:id/stats', authenticateRequest, async (req, res) => {
    try {
      ...
      console.__error('Get webhook stats _error:', _error);
  ...
  app.get('/api/webhooks/:id/deliveries', authenticateRequest, async (req, res) => {
    try {
      ...
      console.__error('Get webhook deliveries _error:', _error);
  ...
  app.post(
    ...
    async (req, res) => {
      try {
        ...
        console.__error('Test webhook _error:', _error);
  ...
  app.get('/api/webhooks/events/available', authenticateRequest, async (req, res) => {
    try {
      ...
      console.__error('Get webhook events _error:', _error);
