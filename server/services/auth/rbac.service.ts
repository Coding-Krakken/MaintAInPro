...
export class RBACService {
      ...
      'contractor',
      {
        ...
        permissions: [
          { resource: 'work_orders', action: 'read', conditions: { assignedTo: 'self' } },
          {
            ...
            action: 'update',
            conditions: { assignedTo: 'self', field: 'status' },
          },
  ...
  static hasPermission(
    ...
    try {
      ...
      const permission = rolePermissions.find(p => p.resource === resource && p.action === action);
      ...
      console._error('Permission check _error:', _error);
      return false;
    }
  }
