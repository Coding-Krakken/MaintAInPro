  ...
  return (
    <div className="p-8">
      ...
      <section className="mb-6">
        ...
        <p>Status: <span className="font-mono">{dbStatus}</span></p>
      </section>
      <section className="mb-6">
      ...
      <div className="mt-8 text-gray-400 text-xs">If you see this page, the debug UI is rendering correctly.</div>
    </div>
  );
};
