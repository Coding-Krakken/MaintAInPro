...
export default function WorkOrders() {
  ...
  return (
    <>
      <div>
        ...
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8'>
          <div>
            ...
            <p className='text-gray-600 mt-1'>Manage and track all maintenance work orders</p>
          </div>
          <Button
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className='text-center py-12'>
                ...
                <Button onClick={() => setShowCreateModal(true)}>Create First Work Order</Button>
              </div>
            ) : (
              <div className='space-y-4'>
      ...
      {showCreateModal && (
        <WorkOrderModal isOpen={showCreateModal} onClose={() => setShowCreateModal(false)} />
      )}
    </>
  );
}
