        ...
        <Card className='p-6'>
          <div className='flex items-center space-x-4'>
            ...
            <div>
              ...
              <p
                className={`text-2xl font-bold ${getStatusColor(metrics?.performance.avgResponseTime || 0, { good: 100, warning: 300 })}`}
              >
        ...
        <Card className='p-6'>
          <div className='flex items-center space-x-4'>
            ...
            <div>
              ...
              <p
                className={`text-2xl font-bold ${getStatusColor(metrics?.memory.usage || 0, { good: 60, warning: 80 })}`}
              >
        ...
        <Card className='p-6'>
          ...
          <div className='space-y-4'>
            ...
            <div className='grid grid-cols-2 gap-4 pt-4'>
              ...
              <div className='text-center'>
                <p
                  className={`text-2xl font-bold ${parseFloat(errorRate) > 5 ? 'text-red-600' : 'text-green-600'}`}
                >
                  {errorRate}%
                </p>
        ...
        <Card className='p-6'>
          ...
          <div className='space-y-4'>
            <div className='grid grid-cols-2 gap-4'>
              <div className='text-center'>
                <p className='text-2xl font-bold text-blue-600'>
                  {metrics?.business.activeWorkOrders || 0}
                </p>
                <p className='text-sm text-gray-600'>Active Work Orders</p>
              </div>
              <div className='text-center'>
                <p
                  className={`text-2xl font-bold ${(metrics?.business.overdueWorkOrders || 0) > 0 ? 'text-red-600' : 'text-green-600'}`}
                >
            ...
            <div className='text-center pt-2'>
              <p className='text-2xl font-bold text-purple-600'>
                {metrics?.business.equipmentCount || 0}
              </p>
