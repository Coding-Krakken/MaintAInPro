  ...
  const phase1Features = [
    {
      ...
      description:
        'WebSocket-powered live notifications for work orders, equipment, and inventory updates',
      status: 'Complete',
      features: [
    ...
    },
    {
      ...
      description:
        'Advanced file upload system with compression, validation, and security features',
      status: 'Complete',
      features: [
    ...
    },
    {
      ...
      description:
        'Intelligent work order escalation with configurable rules and automated notifications',
      status: 'Complete',
      features: [
    ...
    },
    {
      ...
      description:
        'Improved preventive maintenance scheduling with automated work order generation',
      status: 'Enhanced',
      features: [
