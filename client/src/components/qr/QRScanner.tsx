            ...
            <div className='space-y-4'>
              {hasPermission === false && (
                <div className='text-center py-8'>
                  ...
                  <Button onClick={startCameraScanning}>Grant Camera Permission</Button>
                </div>
              )}
          ...
          {mode === 'manual' && (
            <div className='space-y-4'>
              <div>
                ...
                />
                <p className='text-xs text-gray-500 mt-1'>Enter the equipment asset tag manually</p>
              </div>
              ...
              <div className='flex space-x-3'>
                ...
                <Button onClick={handleManualSubmit} disabled={!isValid} className='flex-1'>
                  Submit
                </Button>
              </div>
            </div>
