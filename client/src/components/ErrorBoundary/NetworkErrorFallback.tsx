      ...
      <Card className='w-full max-w-md'>
        <CardContent className='pt-6'>
          <div className='text-center'>
            {/* Network Status Icon */}
            <div
              className={`mx-auto flex h-16 w-16 items-center justify-center rounded-full mb-6 ${getStatusColor()}`}
            >
              {getStatusIcon()}
            </div>
            ...
            <p className='text-sm text-gray-600 mb-6'>{getErrorDescription()}</p>
