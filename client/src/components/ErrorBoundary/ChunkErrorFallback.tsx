  ...
  const handleClearCache = async () => {
    ...
    try {
      ...
      const keysToRemove = Object.keys(localStorage).filter(key => 
        key.startsWith('maintainpro_cache_') || 
          ...
          <div className="text-center">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-800">
                    This usually occurs when the application has been updated and your browser 
                    is trying to load outdated code. Refreshing will download the latest version.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 text-xs text-gray-500">
              <details className="cursor-pointer">
                <summary className="font-medium hover:text-gray-700">Advanced troubleshooting</summary>
                ...
                <details className="cursor-pointer">
                  ...
                  <div className="mt-2 p-2 bg-gray-50 rounded text-left">
                    <div className="font-mono break-words">
                      <div><span className="font-medium">Error:</span> {error.name}</div>
