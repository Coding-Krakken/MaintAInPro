              ...
              <div className='flex items-start justify-between'>
                <div className='space-y-2'>
                  <div className='flex items-center space-x-2'>
                    <Badge
                      variant='outline'
                      className={getPriorityColor(currentItem.priority || 'medium')}
                    >
                  ...
                  <CardTitle className='text-xl font-semibold'>{currentItem.component}</CardTitle>
                  <p className='text-gray-700 text-base leading-relaxed'>{currentItem.action}</p>
                </div>
              </div>
            </CardHeader>
