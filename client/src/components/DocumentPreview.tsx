...
export const DocumentPreview: React.FC<DocumentPreviewProps> = ({
  ...
  const handlePreview = async (attachment: Attachment) => {
    ...
    try {
      ...
      setError(_error instanceof Error ? ___error.message : 'Failed to generate preview');
    } finally {
      setIsLoading(false);
    }
  };
          ...
          <Card key={attachment.id} className='hover:shadow-md transition-shadow'>
              ...
              <div className='flex items-start justify-between'>
                <div className='flex items-center space-x-3'>
                  ...
                  <div className='flex-1'>
                    <CardTitle className='text-sm font-medium'>{attachment.fileName}</CardTitle>
            ...
            <CardContent className='pt-0'>
              <div className='flex items-center justify-between text-xs text-gray-500'>
                <span>Uploaded by {attachment.uploadedBy || 'Unknown'}</span>
                <span>
