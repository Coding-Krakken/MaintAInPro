...
const AdvancedEquipmentAnalytics: React.FC = () => {
  ...
  const summaryMetrics = useMemo(() => {
    ...
    const avgAvailability =
      equipmentMetrics.reduce((sum, e) => sum + e.availability, 0) / totalEquipment;
  ...
  const availabilityDistribution = useMemo(() => {
    ...
    return ranges.map(range => ({
      ...range,
      value: equipmentMetrics.filter(
        e => e.availability >= range.min && e.availability <= range.max
      ).length,
    }));
  }, [equipmentMetrics]);
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
        <Card>
          <CardContent className='p-6'>
            ...
            <Progress value={summaryMetrics.avgAvailability} className='mt-2 h-2' />
          </CardContent>
        </Card>
          ...
          <CardContent className='p-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-2xl font-bold text-blue-600'>{summaryMetrics.avgMtbf}h</p>
          ...
          <CardContent className='p-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-2xl font-bold text-purple-600'>{summaryMetrics.avgMttr}h</p>
              ...
              <CardContent>
                <ResponsiveContainer width='100%' height={300}>
                  <ScatterChart>
                    ...
                    />
                    <Scatter data={mtbfvsHealth} fill={COLORS.primary} />
                  </ScatterChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
                    ...
                    <div className='flex items-center justify-between'>
                      ...
                      <div className='flex items-center space-x-4'>
                        ...
                        <div className='text-right'>
                          ...
                          <Badge
                            variant={equipment.criticalityScore >= 8 ? 'destructive' : 'secondary'}
                          >
          ...
          <Card>
            ...
            <CardContent>
              <div className='space-y-4'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-gray-600'>
                            {equipment.healthScore < 70
                              ...
                              : equipment.trends.availabilityTrend === 'declining'
                                ? 'Declining availability trend'
                                : 'Requires attention'}
                          </p>
                        </div>
                      </div>
                ...
                {equipmentMetrics.filter(
                  e => e.healthScore < 80 || e.trends.availabilityTrend === 'declining'
                ).length === 0 && (
