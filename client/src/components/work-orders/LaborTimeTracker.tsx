...
const LaborTimeTracker: React.FC<LaborTimeTrackerProps> = ({
  ...
  const totalHours =
    laborEntries.reduce((total, entry) => {
            ...
            {isTracking && currentSession ? (
              <div className='space-y-4'>
                <div className='text-center'>
                  ...
                  <p className='text-sm text-muted-foreground mt-1'>{currentSession.description}</p>
                  <p className='text-xs text-muted-foreground'>
                    Started{' '}
                    {formatDistance(currentSession.startTime, new Date(), { addSuffix: true })}
                  </p>
                </div>
      ...
      <Card>
        ...
        <CardContent>
          {laborEntries.length === 0 ? (
            <p className='text-muted-foreground text-center py-4'>No labor time recorded yet</p>
          ) : (
                ...
                >
                  <div className='flex-1'>
                    <div className='flex items-center gap-2 mb-1'>
                      ...
                      <Badge variant='secondary'>{formatDuration(entry.duration || 0)}</Badge>
                    </div>
