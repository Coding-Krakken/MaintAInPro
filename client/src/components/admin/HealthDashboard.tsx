        ...
        <div className="space-y-4">
          <div>
            <div className="flex justify-between text-sm">
              <span>Heap: {heapUsedMB}MB / {heapTotalMB}MB</span>
...
export function HealthDashboard() {
  ...
  const uptimeFormatted = formatDistanceToNow(new Date(Date.now() - health.uptime * 1000), { addSuffix: false });
  ...
  return (
    <div className="space-y-6">
      ...
      {/* WebSocket Details */}
      {health.websocket && Object.keys(health.websocket.connectionsByWarehouse || {}).length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
          ...
          <CardContent>
            <div className="space-y-2">
              {Object.entries(health.websocket.connectionsByWarehouse).map(([warehouse, count]) => (
