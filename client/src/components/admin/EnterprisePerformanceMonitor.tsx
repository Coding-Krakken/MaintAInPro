...
export function EnterprisePerformanceMonitor() {
  ...
  const { data: systemMetrics = [] } = useQuery<SystemMetrics[]>({
    ...
    queryFn: () =>
      fetch(`/api/monitoring/system?range=${selectedTimeRange}`).then(res => res.json()),
            ...
            <CardContent>
              <div className='flex items-center justify-between'>
                <div
                  ...
                  style={{ color: getHealthColor(performanceHealth.overall) }}
                >
          ...
          <Card>
            ...
            <CardContent>
              <div className='flex items-center justify-between'>
                <div
                  className='text-2xl font-bold'
                  style={{ color: getHealthColor(performanceHealth.infrastructure) }}
                >
          ...
          <Card>
            ...
            <CardContent>
              <div className='flex items-center justify-between'>
                <div
                  className='text-2xl font-bold'
                  style={{ color: getHealthColor(performanceHealth.application) }}
                >
          ...
          <Card>
            ...
            <CardContent>
              <div className='flex items-center justify-between'>
                <div
                  className='text-2xl font-bold'
                  style={{ color: getHealthColor(performanceHealth.business) }}
                >
