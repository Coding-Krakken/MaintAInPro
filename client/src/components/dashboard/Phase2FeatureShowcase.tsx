  ...
  const features = [
    {
      ...
      description:
        'Touch-friendly interface with offline capabilities, voice-to-text, and photo capture',
      icon: Smartphone,
      status: 'implemented',
      highlights: [
    ...
    },
    {
      ...
      description:
        'Automatic inventory consumption with real-time stock alerts and reorder notifications',
      icon: ShoppingCart,
      status: 'implemented',
      highlights: [
  ...
  const capabilities = [
    {
      ...
      description: 'Work without internet, sync when online',
    },
    {
      icon: Camera,
      label: 'Photo Capture',
      description: 'Attach photos directly from mobile camera',
    },
    ...
    },
    {
      ...
      description: 'Automated inventory consumption',
    },
  ];
      ...
      <Card className='border-dashed border-2 border-muted'>
        <CardContent className='p-6 text-center'>
          ...
          <p className='text-muted-foreground mb-4'>
            Advanced features like offline PWA capabilities, performance optimization, and security
            hardening are next
          </p>
