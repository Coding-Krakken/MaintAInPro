  ...
  const newFeatures = [
    {
      ...
      description:
        'Complete time tracking system with start/stop timers, manual entry, and detailed reporting',
      icon: Timer,
      status: 'new',
      highlights: [
    ...
    },
    {
      ...
      description:
        'Professional QR code generation for equipment identification and asset tracking',
      icon: QrCode,
      status: 'new',
      highlights: [
    ...
    <div className='mb-8'>
      ...
      <div className='bg-gradient-to-r from-violet-600 via-indigo-600 to-blue-600 rounded-xl p-6 mb-6 text-white'>
        <div className='flex items-center justify-between'>
          ...
          <Badge className='bg-white/20 text-white border-white/30'>Latest Update</Badge>
        </div>
      </div>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        {newFeatures.map((feature, index) => (
          <Card
            key={index}
            className='relative overflow-hidden border-2 hover:border-gray-300 transition-all duration-300 hover:shadow-lg'
          >
            {/* Status Badge */}
            ...
            <CardContent className='space-y-4'>
              ...
              <div className='flex items-center justify-between pt-2'>
                <div className='text-center'>
                  ...
                  <div className='text-xs text-gray-500'>{feature.metrics.label}</div>
                </div>
          ...
          <div className='flex items-center space-x-4'>
            <div className='flex items-center space-x-2'>
              ...
              <span className='text-sm text-gray-600'>
                Start timing work orders with integrated stopwatch
              </span>
            </div>
            ...
            <div className='flex items-center space-x-2'>
              ...
              <span className='text-sm text-gray-600'>
                Generate equipment labels and asset tags
              </span>
            </div>
          </div>
