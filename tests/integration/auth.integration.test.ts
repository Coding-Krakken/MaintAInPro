...
describe('Authentication Integration Tests', () => {
  ...
  describe('POST /api/auth/register', () => {
    it('should register a new user successfully', async () => {
      ...
      const response = await request(testApp).post('/api/auth/register').send(userData).expect(201);
    ...
    it('should reject registration with missing fields', async () => {
      ...
      const response = await request(testApp).post('/api/auth/register').send(userData).expect(400);
  ...
  describe('POST /api/auth/login', () => {
    it('should login with valid credentials', async () => {
      ...
      const response = await request(testApp).post('/api/auth/login').send(credentials).expect(200);
    ...
    it('should reject login with invalid email', async () => {
      ...
      const response = await request(testApp).post('/api/auth/login').send(credentials).expect(401);
  ...
  describe('GET /api/auth/me', () => {
    ...
    it('should reject request without token', async () => {
      const response = await request(testApp).get('/api/auth/me').expect(401);
